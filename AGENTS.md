...
- Benchmark runtime is isolated under `benchmark/`; its authoritative setup, pinning, offline proof, live preflight, safety, grading, and report commands are in `benchmark/docs/BENCHMARK.md`. Never run its live preflight during implementation or CI.
