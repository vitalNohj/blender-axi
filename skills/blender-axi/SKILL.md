...
```
usage: blender-axi [command] [args] [flags]
...
examples[6]: blender-axi ping,blender-axi exec script.py,"blender-axi build build.py --save /tmp/model.blend --render front,side --glb /tmp/model.glb","blender-axi render front,side --out /tmp/renders --res 880x1180",blender-axi start,blender-axi setup hooks
```
