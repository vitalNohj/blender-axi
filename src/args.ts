...
export function requirePositionals(parsed: ParsedArgs, count: number, usageText: string): string[] {
  if (parsed.positionals.length !== count) throw usage(`Expected ${count} argument(s)`, [usageText]);
