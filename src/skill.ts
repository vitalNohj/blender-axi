...
export const SKILL_DESCRIPTION =
	"Drive Blender modeling, rendering, and Python scripting through the blender-axi CLI. Use when creating or inspecting 3D scenes, executing bpy scripts with actionable tracebacks, building and exporting models atomically, or producing camera renders from a running stock BlenderMCP addon.";
